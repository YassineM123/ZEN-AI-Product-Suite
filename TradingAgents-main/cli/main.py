...
app = typer.Typer(
    name="ZEN-Market-Intelligence",
    help="ZEN Market Intelligence: Multi-Agent Financial Research & Market Intelligence by ZEN Groupe",
...
def get_user_selections():
    ...
    welcome_content += "[bold cyan]ZEN Market Intelligence — Multi-Agent Financial Research System[/bold cyan]\n"
    welcome_content += "[bold]ZEN Groupe • Paris | Clermont-Ferrand | Dubai • www.zen-groupe.fr[/bold]\n\n"
    welcome_content += "[bold]Workflow Steps:[/bold]\n"
    welcome_content += "I. Market & Technical Analysts → II. Fundamental & News Analysis → III. Bull vs Bear Debate → IV. Risk Assessment → V. Research Synthesis\n\n"
    welcome_content += (
        "[dim]Institutional Financial Research Platform — ZEN Groupe[/dim]"
    )
    ...
    welcome_box = Panel(
        ...
        border_style="cyan",
        padding=(1, 2),
        title="Welcome to ZEN Market Intelligence",
        subtitle="Multi-Agent Financial Research and Market Intelligence",
    )
