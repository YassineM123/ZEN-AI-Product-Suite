  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 items-center gap-3 px-4">
        <div className="flex size-9 items-center justify-center rounded-lg border border-purple-500/30 bg-purple-950/40 text-purple-400">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[11px] font-semibold tracking-tight text-purple-400">
