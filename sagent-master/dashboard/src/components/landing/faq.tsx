				...
				<div className="text-center mb-12">
					...
					<BlurFade delay={0.3}>
						<p className="text-lg text-muted-foreground">
							Everything you need to know about ZEN Sales Agent. Can&apos;t find the
							answer you&apos;re looking for?{" "}
							<a
								href="mailto:contact@zen-groupe.fr"
								className="text-emerald-400 hover:underline"
							>
								Reach out to our Paris/Dubai team
							</a>
							.
						</p>
					</BlurFade>
				...
				<BlurFade delay={0.5}>
					<div className="mt-10 text-center">
						<p className="text-sm text-muted-foreground">
							...
							>
								Contact our ZEN Groupe advisors
							</a>
						</p>
					</div>
				</BlurFade>
